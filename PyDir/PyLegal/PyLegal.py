...
import os                        # Operating system interfaces (file paths, directory walking, file stats)
import pwd                       # Access to user account information (owner of files)
import grp                       # Access to group account information (group of files)
import stat                      # Interpret file status / permissions (e.g., rwxr-xr-x)
import sys                       # System-specific parameters and functions (e.g., command-line args)
import shutil                    # High-level file operations (copy, move, remove directories)
import json                      # Read/write JSON files
import hashlib                   # Compute cryptographic hashes (SHA-256 for file integrity)
import time                      # Time-related functions (formatting timestamps, modification times)
import csv                       # Read/write CSV files
import tarfile                   # Create or extract tar.gz archives
from datetime import datetime    # Work with dates and times, e.g., timestamps for reports
