#!/usr/bin/python3
#--------------------------------------------------------------------------------------------------
# MSencode is a Shift Cipher but every character has a unique shift table. This is accomplished by 
